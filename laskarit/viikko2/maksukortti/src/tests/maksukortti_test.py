...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_lataussumma_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-50)
        self.assertEqual(self.kortti.saldo_euroina(), 10)

    def test_voi_syoda_edullisesti_kun_kortilla_tasmalleen_oikea_maara(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 0)

    
    def test_voi_syoda_maukkaasti_kun_kortilla_tasmalleen_oikea_maara(self):
